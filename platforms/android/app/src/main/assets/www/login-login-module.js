...
var LoginPage = /** @class */ (function () {
    function LoginPage(fb, nativeStorage, loadingController, router, user) {
        this.fb = fb;
    ...
    LoginPage.prototype.createUser = function (name, email, birthday) {
        ...
        this.user.createUser(name, email, birthday)
            ...
            _this.createUserPoints(res.user_id);
            _this.createUserCredit(res.user_id);
        });
    };
    LoginPage.prototype.createUserPoints = function (email) {
        this.user.createUserPoints(email)
            .subscribe(function (res) {
            console.log(res);
        });
    };
    LoginPage.prototype.createUserCredit = function (email) {
        this.user.createUserCredit(email)
            .subscribe(function (res) {
            console.log(res);
        });
    };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.userExist = function (email) {
        ...
        return this.http.post("http://localhost:3000/api/getUsers", params);
    };
